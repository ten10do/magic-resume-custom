                ...
                <div className={styles.leftContent}>
                    ...
                    <div className={cn("flex flex-col", styles.nameTitle)}>
                        {nameField.visible !== false && basic[nameField.key] && (
                            <motion.h1 layout="position" className="font-bold whitespace-normal break-normal [overflow-wrap:normal]" style={{ fontSize: "30px", color: globalSettings?.themeColor }}>{basic[nameField.key] as string}</motion.h1>
                        )}
