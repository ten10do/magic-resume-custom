    ...
    return (
        <SectionWrapper sectionId="basic">
            <div className={styles.container}>
                <div className={styles.header} style={{ flexDirection: photoPosition === "top" ? "column" : photoPosition === "right" ? "row-reverse" : "row" }}>
                    {PhotoComponent}
                    <div className={`flex flex-col ${styles.nameTitle}`} style={{ color: "#fff", alignItems: alignmentItems[nameAlignment], textAlign: nameAlignment }}>
